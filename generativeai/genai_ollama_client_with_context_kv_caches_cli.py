"""
Ollama KV Cache Client (CLI Version - Non-Interactive)
---------------------------------------------------------
Command-line version that accepts questions as arguments.
Usage: python genai_ollama_client_with_context_kv_caches_cli.py "Your question here"
"""
